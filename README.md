...
![Calculators!](https://img.shields.io/badge/Math-Is%20Awesome-brightgreen)
![Bugs](https://img.shields.io/badge/Bugs-Zero%20(We%20Hope)-blue)
![Dependencies](https://img.shields.io/badge/Dependencies-Just%20Your%20Brain-orange)
![DivZero](https://img.shields.io/badge/Divide%20By%20Zero-Try%20It%20I%20Dare%20You-red)
![Smart](https://img.shields.io/badge/IQ%20Required-Maybe%2012-yellow)
![Coffee](https://img.shields.io/badge/Powered%20By-Coffee%20and%20Tears-brown)
![Developer](https://img.shields.io/badge/Made%20By-A%20Genius-purple)
![Drama](https://img.shields.io/badge/Drama-Level%20100-critical)
![Banana](https://img.shields.io/badge/Banana%20Proof-Absolutely%20Not-yellow)
...
```mermaid
sequenceDiagram
    participant User as You (The Rebel)
    participant Calculator as App (Scared)
    participant Windows as Computer (Angry)
    
    User->>Calculator: Types "hello" in Box 1
    User->>Calculator: Clicks "Plus" Button (Laughing)
    Calculator->>Calculator: Tries to do math with "hello"
    Calculator->>Calculator: Brain melts. Smoke comes out.
    Calculator-->>Windows: HELP ME! WHAT IS THIS? I AM SCARED!
    Windows-->>User: APP CRASHED! FIRE! PANIC! WE ARE DOOMED! WHY DID YOU DO THIS?!
    User->>Windows: Sorry, I will use numbers now.
```
...
```mermaid
pie title How You Will Spend Your Time Here
    "Doing real math homework" : 1
    "Trying to divide by zero" : 20
    "Typing words like 'pizza' to see the app cry" : 49
    "Clicking all buttons super fast like a DJ" : 30
```
